...
#define BUZ_PORT_DATA (GPIO_PORT_1_DATA)
#define BUZ_PORT_DIRECTION (GPIO_PORT_1_DIRECTION)
...
#define PB_DISP_SLEEP_PORT_DATA (GPIO_PORT_2_DATA)
#define PB_DISP_SLEEP_PORT_DIRECTION (GPIO_PORT_2_DIRECTION)
#define PB_DISP_SLEEP_PIN (GPIO_PIN_1)

#define PB_VOL_MINUS_PORT_DATA (PINC) // TODO: Add abstraction to input register in main.h
