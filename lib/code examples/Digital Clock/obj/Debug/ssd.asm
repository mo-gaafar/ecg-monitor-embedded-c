...
;***
;entry:  _SSD_DisplayToggle	;Function start
; 2 exit points
;has an exit
;functions called:
;   _SSD_SetState
...
;  pBlock Stats: dbName = C
;***
;entry:  _SSD_SetLed	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _SSD_SetMode	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _SSD_getCurrentSSD	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;	  421+  143 =   564 instructions ( 1414 byte)
